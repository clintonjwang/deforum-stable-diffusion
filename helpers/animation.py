...
class DeformAnimKeys():
    def __init__(self, anim_args):
        ...
        self.saturation_schedule_series = get_inbetweens(parse_key_frames(anim_args.saturation_schedule), anim_args.max_frames)
        self.brightness_schedule_series = get_inbetweens(parse_key_frames(anim_args.brightness_schedule), anim_args.max_frames)
        self.sharpness_schedule_series = get_inbetweens(parse_key_frames(anim_args.sharpness_schedule), anim_args.max_frames)
